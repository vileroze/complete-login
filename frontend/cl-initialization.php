...
function complete_login_init(){
    ...
    wp_register_script( 'complete-login-fb-btn', plugins_url( '/assets/js/facebook-btn.js', __FILE__ ), false, '1.0.0', false ); //facebook button
    ...
    if ( ! is_user_logged_in() ) {
        ...
        function complete_login_third_party_login($fb_app_id){
            ...
            // echo '<script src="'.plugin_dir_path( __FILE__ ).'/assets/js/facebook-btn.js"></script>';
            // require_once __DIR__ . '/assets/js/facebook-btn.js';
 ...
 function complete_login_third_party_login_providers(){ 
    ...
    <div id="myModal" class="modal">
        ...
        <div class="modal-content">
            ...
            <?php }else{ //the error message if not auth id found ?>
                <div class="user-login">
